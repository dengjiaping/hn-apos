...
/**
 * A {@link RoboPreferenceActivity} extends from {@link PreferenceActivity} to
 * provide dynamic injection of collaborators, using Google Guice.<br />
 * 
 * Note: there is currently a limitation that prevents you from using @InjectView
 * if you use setContentView.
 ...
 * @author Mike Burton
 */
public abstract class TiPreferenceActivity extends RoboPreferenceActivity  implements EventGenerate {
	@Inject
