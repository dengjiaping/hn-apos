...
public class TiPaytypeSpinner extends TiSpinner {
	 ...
	 * R.id.com_txntypes_refund_str); itemIds.put(R.id.com_txntypes_void_layout,
	 * R.id.com_txntypes_void_str); itemImgs.put(R.id.com_txntypes_all_layout,
	 ...
	 * R.string.tqm_txn_types_void_str); for (Integer itemId : itemIds.keySet())
	 * { dialog.findViewById(itemId).setOnClickListener( new
