	...
	protected void onCreate(android.os.Bundle savedInstanceState) {
		...
		cleanBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				SharedPreferences sharedPreferences = getApplication().getSharedPreferences(TiApplication.class.getSimpleName(), 0);
				...
				Intent intent = new Intent(CommonProvider.BROADCAST_CLOSEAPP_ACTION);
