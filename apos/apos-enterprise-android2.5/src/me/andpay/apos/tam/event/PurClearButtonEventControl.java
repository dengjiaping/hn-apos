...
public class PurClearButtonEventControl extends AbstractEventController{
	...
	public void onClick(Activity activity, FormBean formBean, View view) {		
		...
		if(view.getId() == R.id.tam_amt_delete) {
			...
			Selection.setSelection(tiActivity.amtEditText.getEditableText(), tiActivity.amtEditText.length());
			
		}else if(view.getId() == R.id.tam_order_delete) {
			tiActivity.orderText.setText("");
		}else if(view.getId() == R.id.tam_memo_delete) {
			tiActivity.memoText.setText("");
		}*/
