...
public class BalanceDetailActivity extends AposBaseActivity implements ValueContainer {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TxnDetailContext txnDetailContext = getTiFlowControl().getFlowContextData(TxnDetailContext.class);
		
		carImageView.setImageResource(CardOrgImageMap
				.getId(txnDetailContext.getCardAssoc()));
