...
public class CardOrgImageMap {
	...
	static {
		cardMap.put(CardAssoces.CHINA_UNION_PAY,
				R.drawable.com_icon_unionpay_img);
		...
		cardMap.put(CardAssoces.AMERICAN_EXPRESS,
				R.drawable.com_icon_americaexpress_img);
		cardMap.put(CardAssoces.PRIVATED_CARD,
				R.drawable.com_icon_andpaycard_img);

	}

	public static int getId(String orgId) {
		if (StringUtil.isBlank(orgId)
				|| cardMap.get(orgId.toUpperCase()) == null) {
