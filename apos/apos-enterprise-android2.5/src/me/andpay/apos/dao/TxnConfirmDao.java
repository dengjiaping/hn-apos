...
public class TxnConfirmDao extends
		GenSqLiteDao<TxnConfirm, QueryTxnConfirmCond, Integer> {

	public TxnConfirmDao(Context context, String name, CursorFactory factory,
			int version) {
