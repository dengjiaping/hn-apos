...
public class PhoneNumberController extends BaseAdapterController<PhoneNumber>{
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if(arg1==null){
			...
			holder = new Holder();
			holder.name =(TextView)arg1.findViewById(R.id.lft_phone_item_name);
			holder.number=(TextView)arg1.findViewById(R.id.lft_phone_item_number);
		    arg1.setTag(holder);
		}else{
		...
		view.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if(getAdpter().getAdpterEventListener()!=null){
					getAdpter().getAdpterEventListener().onEventListener(getAdpter().getList().get(position));
				}
			}
		});
	}
