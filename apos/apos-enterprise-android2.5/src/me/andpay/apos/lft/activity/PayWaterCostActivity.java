 ...
 * 
 */
@ContentView(R.layout.lft_pay_water)
public class PayWaterCostActivity extends AposBaseActivity {
	@EventDelegate(type = DelegateType.method, toMethod = "back", delegateClass = OnClickListener.class)
	@InjectView(R.id.lft_pay_water_back)
	...
	@EventDelegate(type = DelegateType.eventController, delegate = "addTextChangedListener", delegateClass = TextWatcher.class, toEventController = PayWaterTextWatcherEventControl.class)
	@InjectView(R.id.lft_pay_water_company)
	public EditText company;// 单位

	@EventDelegate(type = DelegateType.eventController, delegate = "addTextChangedListener", delegateClass = TextWatcher.class, toEventController = PayWaterTextWatcherEventControl.class)
	@InjectView(R.id.lft_pay_water_customer_id)
