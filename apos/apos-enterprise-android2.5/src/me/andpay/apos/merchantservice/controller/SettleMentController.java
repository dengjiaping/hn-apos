...
public class SettleMentController extends
		BaseAdapterController<SelementOrder> {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		Holder holder;
		if (arg1 == null) {
			arg1 = ShowUtil.LoadXmlView(TiApplication.getContext(), R.layout.settlement_order_item);
			holder = new Holder();
	...
	public void getEvent(View view, final int position) {
		...
		view.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				getAdpter().getAdpterEventListener().onEventListener(new Object[] { 1, getAdpter().getList().get(position) });
