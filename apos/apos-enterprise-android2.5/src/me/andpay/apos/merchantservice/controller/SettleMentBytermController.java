 ...
 *
 */
public class SettleMentBytermController extends
		BaseAdapterController<SelementOrderByterm> {
	class Holder {
		/* 标题 */
		TextView title;
		/* 交易类型 */
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		final SelementOrderByterm order = getAdpter().getList().get(arg0);
		holder.title.setText("终端号:" + order.getTermNo());
