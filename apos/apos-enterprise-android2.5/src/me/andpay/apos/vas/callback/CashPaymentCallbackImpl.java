...
public class CashPaymentCallbackImpl  implements PurchaseOrderCallback {
	...
	public void networkError() {
		clear();
		TiFlowControlImpl.instanceControl().nextSetup(cashPaymentActivity, FlowConstants.FAILED);
...
//	}
	...
	public void placeOrderSuccess(PurchaseOrder purchaseOrder) {
		...
		TiFlowControlImpl.instanceControl().nextSetup(cashPaymentActivity, FlowConstants.SUCCESS);
	}
