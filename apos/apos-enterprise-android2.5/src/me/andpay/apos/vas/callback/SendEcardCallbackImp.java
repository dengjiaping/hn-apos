...
public class SendEcardCallbackImp implements SendEcardCallback {
	...
	public void netWorkError() {
		...
		Toast toast = Toast.makeText(
				openCardSuccessActivity.getApplicationContext(), "网络异常",
				Toast.LENGTH_LONG);
		toast.show();
	...
	public void sendSuccess() {
		openCardSuccessActivity.commonDialog.cancel();
		Toast toast = Toast.makeText(
				openCardSuccessActivity.getApplicationContext(), "发送成功！",
				Toast.LENGTH_LONG);
		toast.show();
		openCardSuccessActivity.resendBtn.setText(ResourceUtil.getString(
				openCardSuccessActivity.getApplicationContext(),
				R.string.vas_resend_time_str));
