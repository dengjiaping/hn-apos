...
public class CashPlaceOrderCallback implements PurchaseOrderCallback {
	...
	public CashPlaceOrderCallback(
			CashPaymentSuccessActivity cashPaymentSuccessActivity) {
	...
	public void networkError() {
		...
		final PromptDialog dialog = new PromptDialog(
				cashPaymentSuccessActivity, "提示", "网络异常，请稍后重试,在网络恢复前请不要退出此页面。");
	...
	public void placeOrderSuccess(PurchaseOrder purchaseOrder) {
		...
		TiFlowControlImpl.instanceControl().nextSetup(
				cashPaymentSuccessActivity, FlowConstants.SUCCESS);
