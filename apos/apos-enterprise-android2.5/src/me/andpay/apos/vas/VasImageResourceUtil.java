...
public class VasImageResourceUtil {
	...
	static {
		...
		productImg.put(ShopProductTypes.E_SVC,
				R.drawable.com_icon_virtual_card_img);
		productImg.put(ShopProductTypes.SVC_DEPOSIT,
				R.drawable.com_icon_swipe_recharge_img);
	}
