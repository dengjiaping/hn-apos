...
public class ProductSalesFlowFactory {
	...
	static {
		...
		flowMaps.put(ShopProductTypes.PHYSICAL_SVC, FlowNames.VAS_PRODUCT_SALES_1_FLOW);
		fulFillFlowMaps.put(ShopProductTypes.E_SVC, FlowNames.VAS_OPEN_CARD_FLOW);
		fulFillFlowMaps.put(ShopProductTypes.PHYSICAL_SVC, FlowNames.VAS_OPEN_CARD_FLOW);
	}
