...
public class CashPaymentPurchaseOrderFaildTransfer implements
	...
	public Map<String, String> transfterData(Activity activity,
		...
		purchaseOrderFaildContext.setReceiptNo(cashPaymentContext
				.getReceiptNo());
		purchaseOrderFaildContext.setShoppingCart(cashPaymentContext
				.getShoppingCart());
		purchaseOrderFaildContext.setShowOutButton(true);
		purchaseOrderFaildContext.setMsgContent("网络不给力，请重新提交订单信息");
		purchaseOrderFaildContext.setOrderTime(cashPaymentContext
				.getOrderTime());
		return null;
	}
