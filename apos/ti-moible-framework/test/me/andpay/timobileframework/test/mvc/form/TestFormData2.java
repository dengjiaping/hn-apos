...
import me.andpay.timobileframework.test.mvc.form.validation.translate.ErrorMsgTranslaterTest;

@FormInfo(action = "test", domain = "test", formName = "TestFormData")
@FieldErrorMsgTranslate(transType=TRANSTYPE.IMPLEMENTS, Implements=ErrorMsgTranslaterTest.class)
public class TestFormData2 {
